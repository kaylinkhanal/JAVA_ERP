create table INSTALLMENT  (
        ...
        CONSTRAINT Customer_Installment_FK FOREIGN KEY (CUSTOMER_ID) REFERENCES CUSTOMER(CUSTOMER_ID),
        CONSTRAINT Currency_Installment_FK FOREIGN KEY (CURRENCY_ID) REFERENCES CURRENCY(CURRENCY_ID)
)