create table ADDRESS  (
    ...
    CONSTRAINT address_type_enum CHECK (ADDRESS_TYPE IN ('Home', 'Office', 'Other')),
    CONSTRAINT Country_Address_FK FOREIGN KEY (COUNTRY_ID) REFERENCES COUNTRY(COUNTRY_ID),
    CONSTRAINT Customer_ADRESS_FK FOREIGN KEY (CUSTOMER_ID) REFERENCES CUSTOMER(CUSTOMER_ID)
)
