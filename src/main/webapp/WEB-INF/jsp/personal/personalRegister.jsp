         ...
         <form method="post" action="/addCustomer">
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              ...
              <input type="date" class="form-control" id="registerDate" name="registerDate" value="${customer.registerDate}" required/>
            </div>
          </div>
          <div class="form-row">
            <div class="form-group col-md-6">
          ...
          <div class="form-row">
            <div class="form-group col-md-4">
              ...
              <input type="text" class="form-control" id="passportNo" name="idPassportNo" required value="${customer.customerId}"/>
            </div>
            <div class="form-group col-md-4">
              <label for="email">Email:</label>
              <input type="text" class="form-control" id="email" name="email" required value="${customer.customerId}"/>
            </div>

            <div class="form-group col-md-4">
              <label for="contactNo">Contact No</label>
              <input type="text" class="form-control" id="contactNo" name="contactNo" required value="${customer.customerId}" />
            </div>
          </div>
