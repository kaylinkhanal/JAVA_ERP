...
<html>
   <head>
      ...
      <style><%@include file="/WEB-INF/css/fontawesome.css" %></style>
      <style><%@include file="/WEB-INF/css/bootstrap-4.min.css" %></style>
      ...
      <style><%@include file="/WEB-INF/richText/richtext.min.css" %></style>
