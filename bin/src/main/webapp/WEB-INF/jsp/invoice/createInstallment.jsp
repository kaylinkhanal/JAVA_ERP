      ...
      <table border="1" width="60%" class="table table-striped">
        ...
        <c:forEach var="installment" items="${page.getObjects()}">
          ...
          <tr>
            ...
            <td>
              <span class="d-inline-block" tabindex="0" data-toggle="tooltip" title="Edit Installment" data-placement="right">
...
<script>
  $("#addInstallmentForm").submit(function(e) {
    ...
    $.ajax({
      ...
      url: "${${pageContext.request.contextPath}/cb}/invoice/addInstallment/",
