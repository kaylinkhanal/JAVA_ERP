...
$('#addItem').click(function () {
    ...
    $.ajax({
        url: "${${pageContext.request.contextPath}/cb}/invoice/itemList",
        type: "GET",
        success: function (response) {
...
$('#addDeposit').click(function () {
    ...
    $.ajax({
        url: "${${pageContext.request.contextPath}/cb}/invoice/depositList?caseId="+caseId,
        type: "GET",
        success: function (response) {
...
$('#addInstallment').click(function () {
    ...
    console.log(caseId)
    $.ajax({
        url: "${${pageContext.request.contextPath}/cb}/invoice/installmentList?caseId="+caseId,
        type: "GET",
        success: function (response) {
...
$("#itemTable").on('click', 'tr', function (e) {
    ...
    if (id) {
        $.ajax({
            url: "${${pageContext.request.contextPath}/cb}/invoice/findItem/" + id,
            type: "GET",
            success: function (response) {
...
$("#installmentTable").on('click', 'tr', function (e) {
    ...
    if (id) {
        $.ajax({
            url: "${${pageContext.request.contextPath}/cb}/invoice/findInstallment/" + id,
            type: "GET",
            success: function (response) {
...
$("#depositTable").on('click', 'tr', function (e) {
    ...
    if (id) {
        $.ajax({
            url: "${${pageContext.request.contextPath}/cb}/invoice/findDeposit/" + id,
            type: "GET",
            success: function (response) {
